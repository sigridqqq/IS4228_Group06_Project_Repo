...
dt_estimator.fit(train_array, train.cool_label)
y_train_cool = dt_estimator.predict(train_array)
y_val_cool = dt_estimator.predict(val_array)
y_test_cool = dt_estimator.predict(test_array)
print("accuracy score: ", accuracy_score(train.cool_label, y_train_cool))
print("confusion matrix: ")
print(confusion_matrix(train.cool_label, y_train_cool))
