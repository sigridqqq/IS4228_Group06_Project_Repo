'''
In this python script we are using huggingface's pretrained BERT model for fine tuning.

The entire scripts take about 60 hours to complete.
...
# Retrieve pre-trained BERT from huggingface
...
# Make predictions with fine tuned BERT
...
trainer.save_model('/home/q/qshichao/BT4222/Archive/bert')
